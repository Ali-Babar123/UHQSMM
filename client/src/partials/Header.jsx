...
function Header({
  ...
  return (
    <header 
      className={`sticky top-0 before:absolute before:inset-0 before:backdrop-blur-md 
      max-lg:before:bg-gray/90 dark:max-lg:before:dark:bg-[var(--color-dark-rgba)]] 
      before:-z-10 z-30 
      ${variant === 'v2' || variant === 'v3'
        ...
        : 'max-lg:shadow-xs lg:before:bg-gray-100/90 dark:lg:before:bg-[var(--color-dark-rgba)]'}
      ${variant === 'v2' ? 'dark:before:bg-[var(--color-dark-rgba)]' : ''}
      ${variant === 'v3' ? 'dark:before:bg-[var(--color-dark-rgba)]' : ''}
