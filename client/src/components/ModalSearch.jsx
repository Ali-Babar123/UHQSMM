  ...
  return (
    <>
      ...
      >
        <div
          ref={modalContent}
          className="bg-white dark:bg-gray-800  border-gray-200 dark:border-gray-700/60 dark:border border  overflow-auto max-w-2xl w-full max-h-full rounded-lg shadow-lg"
        >
          {/* Search form */}
