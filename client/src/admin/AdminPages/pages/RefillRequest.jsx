                ...
                {orders.map((order, i) => (
                  <tr key={order._id}>
                    ...
                    <td className="px-4 py-2">
                      {order.status === 'View' ? (
                        <Link
                          to="/admin/view-refill-request"
                          className="inline-block px-2 py-1 text-xs font-semibold rounded bg-blue-200 text-blue-800 dark:bg-blue-700 dark:text-blue-100 hover:underline"
                        >
                          View
                        </Link>
                      ) : (
                        <span
                          className={`inline-block px-2 py-1 text-xs font-semibold rounded ${order.status === 'Approved'
