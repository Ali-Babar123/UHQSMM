...
function DropdownNotifications({
  ...
  return (
    <div className="relative inline-flex">
      <button
        ref={trigger}
        className={`w-8 h-8 flex items-center justify-center hover:bg-gray-100 lg:hover:bg-gray-200 dark:hover:bg-blue-700/50 dark:lg:hover:bg-blue-950 rounded-full ${dropdownOpen && 'bg-gray-200 dark:bg-gray-800'}`}
        aria-haspopup="true"
      ...
      >
        ...
        <svg
          className="fill-current text-gray-500/80 dark:bg-[var(--color-dark-gray)] border-gray-200"
          width={16}
          height={16}
          viewBox="0 0 16 16"
